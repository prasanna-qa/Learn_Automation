...
public class Charles {
    ...
    public void converttoCSV() throws InterruptedException {
        try {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        Charles.startCharles();
        Thread.sleep(12000);
        Charles.charlesSessionStart();
        Thread.sleep(12000);
        Charles.downloadCharlesSession();
        Charles.stopCharlesSession();
        Charles.converttoCSV();
        Charles.stopCharles();
