...
public class util {
	...
	public boolean searchColumn(String sheeetName,int rowNum, String colName)
	{
		 boolean s=true;
		XSSFSheet a=workbook.getSheet(sheeetName);
		
		Row r=a.getRow(rowNum);
		Iterator cell=r.cellIterator();
		while(cell.hasNext())
		{
			if(cell.next()==colName)
			{
				return s;
			}
		}
